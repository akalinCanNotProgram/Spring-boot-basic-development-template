package com.akalin.template.comment.aop;

import com.akalin.template.comment.utils.IpInfoUtil;
import com.akalin.template.comment.utils.ThreadPoolUtil;
...
//                    ipInfoUtil.getInfo(request, JSONUtils.toJSONString(request.getParameterMap()));
...
//            type = method.getAnnotation(ApiOperation.class).type().ordinal();
